...
Code style rules for Python FastAPI projects. All rules are enforced by Ruff and mypy.
...
| Package      | `snake_case`         | `routers/`, `services/`    |
| Test class   | `Test` + `PascalCase`| `TestProjectRouter`        |
