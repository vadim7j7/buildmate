...
- SQLAlchemy 2.0 (async) (async sessions, Mapped annotations, relationships)
- Pydantic v2 (schemas, settings, validators)
- Alembic (async) (async migrations, autogenerate)
...
1. `patterns/oauth.md` - Code patterns for routers, services, models, schemas
1. `patterns/pagination.md` - Code patterns for routers, services, models, schemas
1. `patterns/rate-limiting.md` - Code patterns for routers, services, models, schemas
1. `patterns/caching.md` - Code patterns for routers, services, models, schemas
1. `patterns/logging.md` - Code patterns for routers, services, models, schemas
1. `patterns/error-tracking.md` - Code patterns for routers, services, models, schemas
1. `patterns/verification.md` - Code patterns for routers, services, models, schemas
2. `styles/backend-python.md` - Python style guide and conventions
2. `styles/async-patterns.md` - Python style guide and conventions
...
1. **Format**: `cd backend && uv run ruff format --check src/ tests/`
1. **Lint**: `cd backend && uv run ruff check src/ tests/`
1. **Typecheck**: `cd backend && uv run mypy src/`
1. **Tests**: `cd backend && uv run pytest`
