...
- `patterns/frontend-patterns.md` - SSR-first code patterns
- `patterns/auth.md` - SSR-first code patterns
- `patterns/pagination.md` - SSR-first code patterns
- `patterns/i18n.md` - SSR-first code patterns
- `patterns/logging.md` - SSR-first code patterns
- `patterns/error-tracking.md` - SSR-first code patterns
- `patterns/browser-cloning.md` - SSR-first code patterns
- `patterns/verification.md` - SSR-first code patterns
- `styles/frontend-typescript.md` - TypeScript style guide
...
- [ ] Uses Tailwind CSS components where appropriate
