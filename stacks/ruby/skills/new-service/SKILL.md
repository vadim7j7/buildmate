---
name: new-service
description: Generate a service object with spec file
---
...
method and corresponding RSpec spec. This is the generic Ruby version — framework
children (Rails, Sinatra) override with their own conventions.
