---
name: new-component
description: Generate a new React component with TypeScript, Mantine UI, and test file
---
...
with `type`, Mantine UI, proper Server/Client designation, and a co-located
test file.
...
- What Mantine UI components are appropriate?
...
- Use Mantine components (NOT raw HTML elements)
